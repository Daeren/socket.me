...
export type SMSocketEvent = (data: SMSocketClData, response: undefined | SMSocketEventResponse) => void;
...
export type SMAppEventResolvedData = (socket: SMSocket, type: string, data: SMSocketClData, response: undefined | SMSocketEventResponse, next: (() => void)) => void;
